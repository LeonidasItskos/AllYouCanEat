...
public class ProcessorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof ProcessorBlockEntity) {
                ItemScatterer.spawn(world, pos, (ProcessorBlockEntity)blockEntity);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, BlockEntityInit.PROCESSOR_BLOCK, ProcessorBlockEntity::tick);
    }
